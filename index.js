...
// The variable internal can be accessed because the child function (in this case nestedFunction) has access to everything the parent function does.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    let newArray = [];
    let filterAnimals = array.filter(function(data){
...
*/
function CuboidMaker(thisObj){
  this.length = thisObj.length,
